...
PARAM$train$training     <- c( 202106, 202105, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001, 201912, 201911, 201909 )
PARAM$train$validation   <- c( 202107 )
PARAM$train$testing      <- c( 201910, 202104 )
