...
PARAM$modelos_rank  <- c( 1, 2 )  #Que modelos quiero, segun su posicion en el ranking
PARAM$semillas  <- c( 100019, 100043, 100049, 100057, 100069 ) #reemplazar por las propias semillas
