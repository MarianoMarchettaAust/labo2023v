...
PARAM  <- list()
PARAM$experimento <- "TS7410_FINAL_2_JULIO"
...
PARAM$final_train  <- c( 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003, 202002, 202001, 201912, 201911 )
