...
PARAM  <- list()
PARAM$experimento  <- "ZZ7990_FINAL_3_JULIO"
PARAM$exp_input  <- "HT7510_FINAL_3_JULIO"
...
PARAM$semilla_primos  <- 100019  # se utiliza para generar el vector de  PARAM$semillerio  semillas
